...
- 🚀 **Driven to improve** — constantly sharpening my skills and taking on new challenges.
- 🧩 **Three tracks** — Front-End ⚛️ · Full-Stack 🔗 · React Native 📱
- 🤖 **AI-first engineer** — I design and ship AI agents, RAG pipelines, and LLM integrations, and use AI dev tools (Cursor, Copilot, Claude Code) every day.
...
- **Full-Stack** — end-to-end features with Node.js, Nest.js, Express and SQL/NoSQL data layers.
- **React Native** — cross-platform mobile apps with React Native & Expo.
- **AI Engineering** — LLM apps, autonomous agents, RAG, function-calling & multi-agent orchestration.
...
<p>
  ...
  <img src="https://img.shields.io/badge/-Document%20Chunking-0B7285?style=flat-square" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/-Heroku-430098?style=flat-square" />
